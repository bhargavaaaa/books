											...
											<div class=" single-cart-block ">
												<div class="cart-product">
													<a href="product-details.html" class="image">
														<img src="{{ asset('public/front/image/products/cart-product-1.jpg') }}" alt="">
													</a>
													<div class="content">
	...
	<section class="section-margin">
		...
		<div class="container">
			<div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
				...
				<div class="single-slide">
					<img src="{{ asset('public/front/image/others/brand-3.jpg') }}" alt="">
				</div>
				<div class="single-slide">
					<img src="{{ asset('public/front/image/others/brand-4.jpg') }}" alt="">
				</div>
				<div class="single-slide">
					<img src="{{ asset('public/front/image/others/brand-5.jpg') }}" alt="">
				</div>
				<div class="single-slide">
					<img src="{{ asset('public/front/image/others/brand-6.jpg') }}" alt="">
				</div>
				<div class="single-slide">
					<img src="{{ asset('public/front/image/others/brand-1.jpg') }}" alt="">
				</div>

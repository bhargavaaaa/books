        ...
        <div class="container">
            <div class="shop-toolbar mb--30">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-9 col-md-8 col-sm-12  mt--10 mt-sm--0">
                        ...
                        <div class="product-list-content">
                            ...
                            <div class="product-card--body">
                                ...
                                <div class="btn-block">
                                    ...
                                    <a href="javascript:void(0)" data-id="{{ $product->id }}" class="card-link"><i class="fas fa-heart"></i> Add To Wishlist</a>
                                    <a href="javascript:void(0)" data-id="{{ $product->id }}" class="card-link"><i class="fas fa-random"></i> Add To Cart</a>
                                </div>
                            </div>
                        </div>
                    </div>

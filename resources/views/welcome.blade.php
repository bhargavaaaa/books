            ...
            <div class="container">
                <div class="category-gallery-block">
                    <a href="#" class="single-block hr-large">
                        <img src="{{ asset('public/front/image/others/cat-gal-large.png')}}" alt="">
                    </a>
                    <div class="single-block inner-block-wrapper">
                        <a href="#" class="single-image mid-image">
                            <img src="{{ asset('public/front/image/others/cat-gal-mid.png')}}" alt="">
                        </a>
                        <a href="#" class="single-image small-image">
                            <img src="{{ asset('public/front/image/others/cat-gal-small.png')}}" alt="">
                        </a>
                        <a href="#" class="single-image small-image">
                            <img src="{{ asset('public/front/image/others/cat-gal-small-2.jpg')}}" alt="">
                        </a>
                        <a href="#" class="single-image mid-image">
                            <img src="{{ asset('public/front/image/others/cat-gal-mid-2.png')}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="home-left-sidebar">
                            ...
                            <div class="single-side">
                                <a href="#" class="promo-image promo-overlay">
                                    <img src="{{ asset('public/front/image/bg-images/promo-banner-small-with-text.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>

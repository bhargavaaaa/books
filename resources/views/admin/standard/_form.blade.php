                ...
                <div class="col-12 col-lg order-1 order-lg-0">
                    <div class="card mb-5">
                        ...
                        <div class="card-body table-responsive">
                            <form action="{{ route('standard.update', encrypt($standard->id)) }}" method="POST"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 mb-3 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Name"
                                            value="{{ old('name', $standard->standard_name) }}" />
                                        <input type="hidden" id="id" name="id" value="{{ $standard->id }}" />
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12 mb-3 col-sm-12">
                                        ...
                                        <textarea class="ckeditor form-control description" name="description"
                                            id="description">{!! $standard->standard_description !!}</textarea>

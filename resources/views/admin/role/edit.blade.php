        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('role.update', encrypt($role->id)) }}" id="role_form" method="post" class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="name" class="form-control input-sm" id="name" placeholder="Name" value="{{ $role->name ?? old('name') }}">
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="Enter Description" style="resize:none;" rows="2">{{ $role->description ?? old('description') }}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 card-dark permissions-list">
                                            <div class="mt-3 card-header">
                                                <h5 class="mt-2 card-title">{{ $key ?? '' }}</h5>
                                                <div class="card-tools">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @php
                                                $checked = '';
                                                if(in_array($val->id, $role_permission))
                                                $checked = 'checked';
                                                @endphp

                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input permission" name="permission[]" type="checkbox" id="customCheckbox{{$cn}}" value="{{ $val->id }}" {{$checked}}>

        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('users.update', encrypt($user->id)) }}" id="user_form" method="post" class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" name="name" class="form-control input-sm" id="name" placeholder="Name" value="{{ $user->name ?? old('name') }}">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="email" name="email" class="form-control input-sm" id="email" placeholder="Email" value="{{ $user->email ?? old('email') }}">
                                        @if ($errors->has('email'))

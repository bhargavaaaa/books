        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('cms_page.store') }}" id="form" method="post" class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="name" class="form-control input-sm" id="name" placeholder="CMS Name" value="{{ old('name') }}">
                                        @if ($errors->has('name'))
